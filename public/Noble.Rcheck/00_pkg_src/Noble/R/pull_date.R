...
#' tempDir<- tempdir()
#' pull.date(site = "CPER", dpID = "DP1.00002.001", bgn.month = "2017-03-15 00:00:00",
...
pull.date=function(site, dpID, bgn.date, end.date, time.agr, package, save.dir){
    ...
    out=Noble::date.extract(data = Noble::data.pull(site = site,
                                                dpID = dpID,
                                                bgn.month = bgn.month,
                                                end.month = end.month,
                                                time.agr = time.agr,
