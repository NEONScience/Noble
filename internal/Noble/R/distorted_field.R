...
distorted.field=function(site){
    ...
    B_min = thresholds$Distorted.flow.min.buffer.angle[thresholds$SITE==site] # min distorted flow angle
    B_max = thresholds$Distorted.flow.min.buffer.angle[thresholds$SITE==site] # max distorted flow angle
